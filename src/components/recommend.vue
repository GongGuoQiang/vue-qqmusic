<template>
	...
	<div class="page">
        ...
        :title="topinfo.dissname + data.day_of_year + `天`"
        :showTitle="showTitle">
        ...
        <div class="page-content" style="overflow:hidden">
            <div class="music-cover-wrap">
                ...
                ref="musicCover" :style="{backgroundImage:`url(${topinfo.logo})`}"></div>
...
<script>
	...
	export default {
        ...
        mounted() {
            this.$http.get('/api/qzone/fcg-bin/fcg_ucc_getcdinfo_byids_cp.fcg',{
                params: {
